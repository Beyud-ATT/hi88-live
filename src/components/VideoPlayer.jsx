...
const LivestreamPlayer = ({ liveId }) => {
  ...
  return (
    <>
      {pathname.includes("live") && (
        <div className="bg-[var(--video-player-bg)] w-full px-4 h-[85px] flex items-center justify-between">
          <div className="flex">
            <Avatar
            ...
            <div className="flex flex-col justify-center ml-4">
              <Typography.Title
                level={2}
                className="!font-bold !text-[var(--color-brand-primary-lighter)] xl:!text-[1.0rem] lg:!text-[.7rem] !text-[.5rem]"
              >
              ...
              <div className="flex items-center justify-start space-x-4">
                <Typography.Title
                  level={3}
                  className="!font-bold xl:!text-[.8rem] !text-[.6rem] !m-0 !text-[var(--color-brand-primary-lighter)]"
                >
                  {liveDetailData?.displayName}
                </Typography.Title>
                <div className="flex items-center justify-center space-x-1 text-[var(--color-brand-primary-lighter)]">
                  <FaRegEye />
                  <span>
          ...
          <button
            ...
            className={`text-[var(--color-brand-primary)] 
              ...
              bg-[var(--color-brand-primary-lighter)] 
